		...
		new SqlAgent() {
			...
			protected void doJob() throws Exception {
				...
				while (rs.next()) {
					...
					mvo.setDsc(rs.getString(3));
					mvo.setCate(rs.getString(4));
					mvo.setUserid(rs.getString(5));
					mvo.setFilename(rs.getString(6));
					mvo.setRegdate(rs.getDate(7));
					mvo.setRcount(rs.getInt(8));
					mvo.setVcount(rs.getInt(9));
					mvo.setArtist(rs.getString(10));
					mvo.setImg(rs.getString(11));
					mvo.setAlbname(rs.getString(12));
